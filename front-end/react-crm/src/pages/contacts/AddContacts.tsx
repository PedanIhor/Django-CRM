...
function AddContacts() {
  ...
  useEffect(() => {
    if (formData.type === 'corporate') {
      // Fetch accounts when type is corporate
      const Header = {
      ...
      fetchData(`/api/accounts/`, 'GET', null as any, Header)
        .then((res) => {
          if (!res.error) {
            // Combine open and closed accounts
            const allAccounts = [
              ...(res.active_accounts?.open_accounts || []),
              ...(res.closed_accounts?.close_accounts || []),
            ];
              ...
              <Accordion style={{ width: '98%' }} defaultExpanded>
                ...
                <AccordionDetails>
                  ...
                  >
                    ...
                    <div className="fieldContainer2">
                      <div className="fieldSubContainer">
                        <div className="fieldTitle">Contact Type</div>
