              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    />
                    &nbsp;&nbsp;
                    {accountDetails?.created_by?.first_name} {accountDetails?.created_by?.last_name}
                      ...
                      <div key={contact.id}>
                        <Link
                          ...
                          onClick={() => navigate('/app/contacts/contact-details', {
                            state: { contactId: contact.id, detail: true, countries }
                          })}
                          sx={{
                            cursor: 'pointer',
                            textDecoration: 'none',
                ...
                <div style={{ width: '32%' }}>
                  ...
                  <div className="title3">
                    {accountDetails?.industry ? 
                        accountDetails.industry.charAt(0).toUpperCase() + accountDetails.industry.slice(1).toLowerCase()
                        : '----'
                    }
                  </div>
                </div>
