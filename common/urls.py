...
urlpatterns = [
    ...
    path('notifications/<str:pk>/mark-as-read/', views.MarkNotificationAsReadView.as_view(), name='mark-notification-read'),
    ...
    path('upload-profile-pic/', views.UploadProfilePicView.as_view(), name='upload-profile-pic'),
]
if settings.DEBUG:
